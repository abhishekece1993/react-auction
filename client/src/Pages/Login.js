            ...
            <div className="container auth-form">
                ...
                <Form className="col-lg-6" onSubmit={handleSubmitLogin}>
                    ...
                    {loading ?
                        ...
                        :
                        <Button variant="primary" className="col-lg-12 btnAuth" type="submit">Sign In</Button>
                    }
                    <p className="bottom-msg-paragraph">Don't have an account? <Link to="/auth/register" style={{color: '#007bff'}}>Sign Up!</Link></p>
                </Form>
            </div>
        </>
    )
