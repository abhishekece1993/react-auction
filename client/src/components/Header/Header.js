...
import { Navbar, NavDropdown, Nav, OverlayTrigger, Tooltip, Button } from 'react-bootstrap';
    ...
    return (
        <Navbar collapseOnSelect bg="light" variant="light">
            <div className="container">
                <Navbar.Brand>
                    <NavLink className="navbar-brand" to="/"><Image className='logo-image' src={img} thumbnail={true} /></NavLink>
                </Navbar.Brand>
